...
def add_sphere(polygons, cx, cy, cz, r, steps ):
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop+1):
            ...
            add_polygon(polygons, points[index][0],points[index][1],points[index][2],points[(index+1)%len(points)][0],points[(index+1)%len(points)][1],points[(index+1)%len(points)][2],points[(index+1+steps)%len(points)][0],points[(index+1+steps)%len(points)][1],points[(index+1+steps)%len(points)][2])
            add_polygon(polygons, points[index][0],points[index][1],points[index][2],points[(index+1+steps)%len(points)][0],points[(index+1+steps)%len(points)][1],points[(index+1+steps)%len(points)][2],points[(index+1)%len(points)][0],points[(index+1)%len(points)][1],points[(index+1)%len(points)][2])
